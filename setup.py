...
lambda_name = 'dynamo-parquet-etl'
...
lambda_description = 'Lambda providing dynamic etl from dynamo to parquet'
...
lambda_install_requires = ['jsonpointer', 'pandas', 'pyarrow']
